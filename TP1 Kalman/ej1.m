...
%
% Ejercicio 1 (teórico) y 2 (simulación)
% -------------------------------------------------------------------------- %
...
title('Posición');
% print('-dpng', 'ej1/Trayectoria.png');
...
% print('-dpng', 'ej1/Correlacion_de_innovaciones.png');
...
% print('-dpng', 'ej1/Errores_de_estimacion.png');
...
% print('-dpng', 'ej1/Realizacion_del_error.png');
...
title('Velocidad sin sesgo');
print('-dpng', 'ej1/Velocidad.png');
