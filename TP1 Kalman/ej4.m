...
radar_file_name = 'archivos_tp/Radar-sesgo-pos.mat';
...
rank([Ck * Ak; Ck*Ak*Ak])
% El rango da 6 => no todos los estados son observables
% var_pos_x = P_hat(1,1,:);
% var_pos_y = P_hat(2,2,:);
% var_vel_x = P_hat(3,3,:);
% var_vel_y = P_hat(4,4,:);
...
title('Posición');
print('-dpng', 'ej4/Trayectoria.png');
...
print('-dpng', 'ej4/Correlacion_de_innovaciones.png');
...
print('-dpng', 'ej4/Errores_de_estimacion.png');
...
print('-dpng', 'ej4/Realizacion_del_error.png');
